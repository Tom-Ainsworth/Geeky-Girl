...
const Home = () => <div className={styles.Home}>
    ...
    <div className={styles.container}>
        ...
        <div className={styles.box}>
            ...
            <p>As of 2023, women hold 26.7% of technology jobs.
        ...
        <div className={styles.box}>
            <h3>pay disparity</h3>
            <p>Its overall national mean gender pay gap is 15.4pc,
